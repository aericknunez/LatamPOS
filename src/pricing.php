                            ...
                            <div class="s2-pricing_item">
                                ...
                                <div class="s2-pricing_list ul-li-block">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                            Manejo de gastos, entradas y salidas de efectivo
                                        </li>
                                        <li>
                                            <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                        ...
                                        <li>
                                            <div class="s2-pricing_list_icon s2-unchecked float-left text-center"><i class="fas fa-times"></i></div>
                                            Comandas en cocina en pantalla o ticket
                                        </li>
                                    </ul>
                                </div>
                                <div class="s2-pricing_btn">
                                    <a href="https://wa.me/50368275365?text=Quiero%20adquirir%20el%20sistema%20Latam%20POS%20basico"><i class="fab fa-whatsapp"></i> Adquirir</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="s2-pricing_item">
                                ...
                                <div class="s2-pricing_list ul-li-block">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                            Comandas en cocina en pantalla o ticket (1)
                                        </li>
                                        <li>
                                            <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                            Restricciones para meseros
                                        </li>
                                        <li>
                                            <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                            Multiples tipos de pagos para clientes
                                        </li>
                                        <li>
                                ...
                                <div class="s2-pricing_btn">
                                    <a href="https://wa.me/50368275365?text=Quiero%20adquirir%20el%20sistema%20Latam%20POS%20estandar"><i class="fab fa-whatsapp"></i> Adquirir</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="s2-pricing_item">
                             ...
                             <div class="s2-pricing_list ul-li-block">
                                <ul>
                                    ...
                                    <li>
                                        <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                        Comandas en cocina en pantalla o ticket (3)
                                    </li>
                                    <li>
                                        <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                        Toma de pedidos desde Tablet o SmartPhone
                                    </li>
                                    <li>
                                        <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                    ...
                                    <li>
                                        <div class="s2-pricing_list_icon s2-checked float-left text-center"></div>
                                        Multiples cajas de cobro
                                    </li>
                                </ul>
                            </div>
                            <div class="s2-pricing_btn">
                                <a href="https://wa.me/50368275365?text=Quiero%20adquirir%20el%20sistema%20Latam%20POS%20premium"><i class="fab fa-whatsapp"></i> Adquirir</a>
                            </div>
                        </div>
                    </div> 
                </div>
